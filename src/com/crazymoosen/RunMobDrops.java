...
public class RunMobDrops extends JavaPlugin implements Listener {
	
	@Override
	public void onEnable() {
		getServer().getPluginManager().registerEvents(new DetectForItemDrops(), this);
		getServer().getPluginManager().registerEvents(new DetectForMobDrops(), this);
